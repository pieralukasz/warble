...
final class RecordingStoreTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testDir = FileManager.default.temporaryDirectory.appendingPathComponent("warble-test-\(UUID().uuidString)")
    ...
    func testTempRecordingURL() {
        ...
        XCTAssertTrue(url.lastPathComponent.hasPrefix("warble-recording-"))
        XCTAssertEqual(url.pathExtension, "wav")
    }

...
<Screenshot name="menubar" darkName="menubar-dark" alt="The Warble menu bar panel" caption="Click the menu bar icon for the status, your last dictation and quick toggles." bare className="mx-auto max-w-sm" />

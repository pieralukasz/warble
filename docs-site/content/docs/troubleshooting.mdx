...
The first launch needs an internet connection to fetch Parakeet from Hugging Face. Check the connection and press **Try Again** on the Home screen or in setup.
